...
$(document).ready(() => {
    ...
    var isIPadPro = (navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 0) || navigator.platform === 'iPad';
    ...
    let target2 = (isMobile || isiPad || isIPadPro) ? $('.intro').find('.basic-cloud') : $('.section2').find('.cloud-circle');
    ...
    let target3 = (isMobile || isiPad || isIPadPro) ? $('.intro').find('.basic-cloud') : $('.section3').find('.cloud-circle');
